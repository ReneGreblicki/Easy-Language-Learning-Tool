...
VOICE_DEFAULTS: dict[Language, tuple[str, str]] = {
    ...
    Language.POLISH: ("pl-PL-ZofiaNeural", "pl-PL-MarekNeural"),
    Language.DUTCH: ("nl-NL-ColetteNeural", "nl-NL-MaartenNeural"),
    Language.DANISH: ("da-DK-ChristelNeural", "da-DK-JeppeNeural"),
    Language.CROATIAN: ("hr-HR-GabrijelaNeural", "hr-HR-SreckoNeural"),
    Language.VIETNAMESE: ("vi-VN-HoaiMyNeural", "vi-VN-NamMinhNeural"),
    Language.SIMPLIFIED_CHINESE: ("zh-CN-XiaoxiaoNeural", "zh-CN-YunxiNeural"),
    Language.MALAYALAM: ("ml-IN-SobhanaNeural", "ml-IN-MidhunNeural"),
    Language.SLOVAK: ("sk-SK-ViktoriaNeural", "sk-SK-LukasNeural"),
    Language.RUSSIAN: ("ru-RU-SvetlanaNeural", "ru-RU-DmitryNeural"),
    Language.NORWEGIAN: ("nb-NO-PernilleNeural", "nb-NO-FinnNeural"),
    Language.KOREAN: ("ko-KR-SunHiNeural", "ko-KR-InJoonNeural"),
    Language.HUNGARIAN: ("hu-HU-NoemiNeural", "hu-HU-TamasNeural"),
    Language.SWEDISH: ("sv-SE-SofieNeural", "sv-SE-MattiasNeural"),
    Language.INDONESIAN: ("id-ID-GadisNeural", "id-ID-ArdiNeural"),
    Language.JAPANESE: ("ja-JP-NanamiNeural", "ja-JP-KeitaNeural"),
    Language.TURKISH: ("tr-TR-EmelNeural", "tr-TR-AhmetNeural"),
}
...
LANGUAGE_BADGES: dict[Language, str] = {
    ...
    Language.SIMPLIFIED_CHINESE: "ZH",
