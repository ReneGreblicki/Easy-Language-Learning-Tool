...
def build_batch_prompt(settings: GenerationSettings, plans: list[PlannedRow]) -> str:
    ...
    return (
        ...
        "A grammatical_person of 'neutral' means a neutral or impersonal sentence structure without "
        "a personal pronoun as the subject (for example, 'The day is nice', 'The sun is up', or "
        "'The school is far'). Every other grammatical_person must be reflected by the matching "
        "personal pronoun or person in the sentence. Each sentence must stand alone, make sense without "
        "context, obey its exact question/statement "
